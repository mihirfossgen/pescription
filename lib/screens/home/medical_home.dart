...
class MediacalHome extends StatefulWidget {
  final String role;
  final dynamic object;
  MediacalHome({Key? key, required this.role, required this.object})
      : super(key: key);
  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<MediacalHome> {
  ...
  void chooseDay(CalendarDayModel clickedDay) {
    setState(() {
      ...
      allListOfPills.forEach((pill) {
        DateTime pillDate =
            DateTime.fromMicrosecondsSinceEpoch(pill.time ?? 0 * 1000);
